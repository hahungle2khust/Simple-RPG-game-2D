...
namespace Test.Forms
{
    public partial class Character_Palette : Form
    {
        ...
        private void btnNew_Click(object sender, EventArgs e)
        {
            ...
            newCharType.WaitAfterAttack = new Point((int)nudWaitMin.Value, (int)nudWaitMax.Value);
        ...
        private void lbCharList_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (lbCharList.SelectedIndex > -1)
            {
                ...
                nudWaitMin.Value = newCharType.WaitAfterAttack.X;
                nudWaitMax.Value = newCharType.WaitAfterAttack.Y;
